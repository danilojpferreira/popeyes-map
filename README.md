...
There is an install and use guide for each app in this project. It is recommended to start in the following order: database, backend and frontend.

## Requirements and Install

To run this project you need to have the following software installed and running on your computer:
